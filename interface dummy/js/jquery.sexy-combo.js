...
;(function($) {
    ...
    $.sexyCombo = function(selectbox, config) {
        ...
        this.icon = $("<div class='ui-state-default'/>").
	    ...
	    this.options.each(function() {					   
			...
			if (self.config.checkWidth) {
			    optWidths.push($("<li class='ui-state-default'/>").
	            appendTo(self.list).
    ...
    $sc.fn.extend({
	    ...
	    highlight: function(activeItem) {
	        ...
	        this.listItems.removeClass("ui-state-hover");   
	        $(activeItem).addClass("ui-state-hover");
	    },
	...
	getActive: function() {
	    return this.listItems.filter(".ui-state-hover");
	},
	...
	highlightFirst: function() {
	    this.listItems.removeClass("ui-state-hover").filter(".visible:eq(0)").addClass("ui-state-hover");
	    this.autoFill();
	},
	...
	highlightPrev: function() {
	    ...
	    while ($prev.length && $prev.hasClass("invisible"))
            ...
            if ($prev.length) {
	        this.getActive().removeClass("ui-state-hover");
