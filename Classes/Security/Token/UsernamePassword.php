...
class UsernamePassword implements \TYPO3\FLOW3\Security\Authentication\TokenInterface {
	 ...
	 *
	 * @param \TYPO3\FLOW3\Object\ObjectManagerInterface $objectManager The object factory
	 * @return void
	...
	public function setAuthenticationStatus($authenticationStatus) {
		if (!in_array($authenticationStatus, array(self::NO_CREDENTIALS_GIVEN, self::WRONG_CREDENTIALS, self::AUTHENTICATION_SUCCESSFUL, self::AUTHENTICATION_NEEDED))) throw new \TYPO3\FLOW3\Security\Exception\InvalidAuthenticationStatusException('Invalid authentication status.', 1237224453);
